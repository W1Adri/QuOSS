...
> **ARCHIVADO el 2026-09-19.** Este es el documento de reimplementación v3
> completo, tal como se escribió el 2026-07-31, antes de que existiera una sola
> línea de `quoss`. Se conserva íntegro porque **la reimplementación que propone
> ya ocurrió**: sus §1 (estructura de directorios), §2 (tooling, rendimiento,
> calidad) y §5 (mejoras de física y de flujo) describen decisiones que hoy están
> tomadas y que viven donde se leen — `notes/ROADMAP.md` el orden y el estado,
> `CLAUDE.md` las reglas que no se negocian, y `docs/adr/` cada decisión no
> obvia. Dejarlo en el camino de lectura lo convertía en una **tercera fuente de
> verdad** sobre las mismas cosas, que es cómo un documento correcto empieza a
> mentir: no cambiando, sino quedándose quieto mientras el árbol se mueve.
>
> Lo que **no** tenía otro dueño sigue vivo en
